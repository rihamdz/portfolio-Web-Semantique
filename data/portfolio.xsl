...
<div class="skill-category" role="listitem" data-category-id="{@id}">
...
<div class="skill-bar" role="progressbar" aria-valuenow="{$levelPct}" aria-valuemin="0" aria-valuemax="100" aria-label="{@name} – {$levelPct}%">
<div class="skill-bar-fill" style="width:{$levelPct}%"/>
</div>
</li>
</xsl:template>
<!--  ================================================================
...
<article class="project-card" data-type="{@type}" id="{@id}" itemscope="itemscope" itemtype="http://schema.org/SoftwareSourceCode">
...
<a class="project-link" href="{projectLink/@url}" target="_blank" rel="noopener noreferrer" itemprop="codeRepository">
...
<article class="experience-card" id="{@id}" itemscope="itemscope" itemtype="http://schema.org/OrganizationRole">
...
<xsl:value-of select="period_exp"/>
</span>
<span class="exp-location">
<xsl:value-of select="location_exp"/>
</span>
